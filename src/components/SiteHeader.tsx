...
function FeatureBlock({
  ...
  return (
    <div className="relative overflow-hidden rounded-[4px] bg-nav-navy/40 p-6">
      {children}
...
function DemoButton({
  ...
  return (
    <a
      href="#contact"
      onClick={onClick}
      className={`group inline-flex h-12 items-center justify-center gap-2 rounded-[4px] bg-orange px-5 text-[15px] font-semibold text-white transition-[filter] duration-[180ms] hover:brightness-110 ${full ? "w-full" : ""} ${className}`}
    >
      Request a Demo
...
export default function SiteHeader() {
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto grid h-20 max-w-[1360px] grid-cols-[1fr_auto_1fr] items-center px-6 max-lg:flex max-lg:justify-between">
        <a
          href="#top"
      ...
      {openId && (
        <div
          ...
          onMouseEnter={cancelClose}
        >
          <div className="mx-auto max-w-[1320px] px-8 py-11">
            {(() => {
